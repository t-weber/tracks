 ...
 */
class DistancesDlg : public QDialog
{ Q_OBJECT
public:
	DistancesDlg(QWidget *parent = nullptr);
	virtual ~DistancesDlg();

	DistancesDlg(const DistancesDlg&) = delete;
	DistancesDlg& operator=(const DistancesDlg&) = delete;
